...
@Entity
@Table(name = "vestibilita")
public class Vestibilita {
    ...
    public Vestibilita(Integer id, String desc, List<Camicia> camicie, List<Vestito> vestiti, List<Pantalone> pantaloni,
